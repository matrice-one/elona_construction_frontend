...
<ul>
    ...
    >
                ...
                <p class="tag is-medium is-primary is-light is-rounded my-1" > {{ profileIndexSelected }} {{  selection.name }} {{ selectionIndex }}<button class="delete" @click="onDeleteSelection(selectionIndex)"></button></p>
